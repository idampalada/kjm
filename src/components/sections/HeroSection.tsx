    ...
    >
      ...
      <div className="container mx-auto px-4 py-28 md:py-40 relative z-10 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <Link
            href="/about-us"
            className="inline-block bg-[#7e072e] hover:bg-[#6a0625] text-white font-bold px-8 py-4 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg"
            style={{
              fontFamily:
                'ui-sans-serif, system-ui, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"',
              fontWeight: 700,
