      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-300 max-w-2xl mx-auto">
            Kami siap membantu Anda dengan kebutuhan logistik dan transportasi.
            Silakan isi formulir di bawah ini untuk konsultasi gratis.
          </p>
        </div>
          ...
          {submitSuccess ? (
            <div className="bg-[#0e162e] border border-[#7e072e] p-8 rounded-lg text-center shadow-lg">
              ...
              <p className="text-gray-300 mb-6">
                Pesan Anda telah dikirim. Tim kami akan segera menghubungi Anda
